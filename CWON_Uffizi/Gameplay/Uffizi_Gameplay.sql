...
VALUES		('GREATWORK_CWON_BOTTICELLI_1',	'GREATWORKOBJECT_RELIGIOUS',		'GREAT_PERSON_INDIVIDUAL_CWON_BOTTICELLI',		'LOC_GREATWORK_CWON_BOTTICELLI_1_NAME',			'GREATWORK_IMAGE_CWON_BOTTICELLI_1',	2,			''),
			...
			('GREATWORK_CWON_TITIAN_1',	'GREATWORKOBJECT_PORTRAIT',		'GREAT_PERSON_INDIVIDUAL_CWON_TITIAN',		'LOC_GREATWORK_CWON_TITIAN_1_NAME',			'GREATWORK_IMAGE_CWON_TITIAN_1',		2,			''),
			('GREATWORK_CWON_TITIAN_2',	'GREATWORKOBJECT_LANDSCAPE',		'GREAT_PERSON_INDIVIDUAL_CWON_TITIAN',		'LOC_GREATWORK_CWON_TITIAN_2_NAME',			'GREATWORK_IMAGE_CWON_TITIAN_2',		2,			''),
			('GREATWORK_CWON_TITIAN_3',	'GREATWORKOBJECT_RELIGIOUS',		'GREAT_PERSON_INDIVIDUAL_CWON_TITIAN',		'LOC_GREATWORK_CWON_TITIAN_3_NAME',			'GREATWORK_IMAGE_CWON_TITIAN_3',		2,			'');
